...
const StoriesCard = ({ desc, image }) => {
  return (
    <div className=" relative overflow-hidden h-[650px] w-full group">
      <div className="">
        <img
          src={image}
          alt=""
          className="h-[650px] group-hover:scale-110 scale-100 animate object-cover "
        />
      </div>
